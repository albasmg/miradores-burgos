import photo1 from '../../../assets/images/mirador-8/desde-arcosantamaria-1.jpg';
import photo2 from '../../../assets/images/mirador-8/desde-arcosantamaria-2.jpg';
import photo3 from '../../../assets/images/mirador-8/desde-arcosantamaria-3.jpg';
import photo4 from '../../../assets/images/mirador-8/desde-arcosantamaria-4.jpg';
import photo5 from '../../../assets/images/mirador-8/desde-arcosantamaria-5.jpg';

const MIRADOR_2 = {
  subheaderTitle: 'Desde el Arco de Santa María',
  introduction: {
    text: {
      firstParagraph:
  ...
  sections: [
    {
      title: 'Un puente con mucha historia',
      bodyText:
    ...
    {
      title: 'La vista más impactante',
      bodyText:
        'Y para finalizar este intenso recorrido por los miradores desde donde homenajear a la Catedral de Burgos en el VIII centenario de la colocación de su primera, nada mejor que pasar por debajo del arco de Santa María y asomarse a una de las más icónicas perspectivas del patrimonio artístico español. Los visitantes que descubren por primera la plaza del Rey San Fernando, principal responsable junto al obispo don Mauricio de la construcción del templo a partir de 12121, se quedan sobrecogidos con la belleza que se muestra ante sus ojos. Ante ellos se alzan, majestuosos e inconfundibles, todos los volúmenes arquitectónicos que dan forma a la Catedral y en concreto a la denominada fachada del Sarmental.',
      linkText: 'LINK',
      image: [photo5],
    },
  ],
  nextSteps: {
    text:
      'Una vez en la plaza del Rey San Fernando, los viajeros tienen varias opciones: regresar al punto de partida, junto a la entrada de MEH, disfrutando de las famosas vistas desde el Paseo del Espoloncillo; decidirse a dar una completa vuelta por el perímetro de la Catedral; o bien, entrar dentro del templo para disfrutar de una experiencia difícil de olvidar.',
    nextMirador: '/cartuja',
  },
};

export default MIRADOR_2;
