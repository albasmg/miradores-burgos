...
const MIRADOR_2 = {
  subheaderTitle: 'Desde el Paseo del Espolón',
  introduction: {
    text: {
      firstParagraph:
  ...
  sections: [
    {
      title: 'El paseo más burgalés',
      bodyText:
        'Comenzó como un eslogan promocional, pero cada vez son más los visitantes que lo han hecho suyo: ‘Sentirse burgalés en Burgos’. Y para cumplir esta premisa, nada mejor que recorrer tranquilamente el Espolón y mezclarse con los nativos en su deambular entre las entrelazadas hileras de plátanos de sombra. Con cerca de 230 años de historia, es uno de los paseos más conocidos de España. Su longitudinal trazado, en el que se pueden rastrear la huella dejada por las sucesivas reformas, discurre en paralelo al río Arlanzón. En su salón central, entre castaños de indias, recortados tejos y acacias, se descubren ocho estatuas neoclásicas de reyes y personajes ligados a la historia de Burgos.',
      image: [photo2],
    },
    {
      title: 'Una ciudad de mercaderes',
      bodyText:
