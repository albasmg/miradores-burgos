...
const MIRADOR_4 = {
  ...
  sections: [
    {
      title: 'Las Llanas de la abadesa',
      bodyText:
    ...
    {
      title: 'Ser peregrino por un día',
      bodyText:
  ...
  nextSteps: {
    ...
    nextMirador: '/miradores/5',
  },
};

export default MIRADOR_4;
